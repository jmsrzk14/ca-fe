 ...
 *
 * @generated from message helloworld.v1.HelloRequest
 */
export class HelloRequest extends Message<HelloRequest> {
  ...
  static readonly typeName = "helloworld.v1.HelloRequest";
 ...
 *
 * @generated from message helloworld.v1.HelloReply
 */
export class HelloReply extends Message<HelloReply> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "helloworld.v1.HelloReply";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
