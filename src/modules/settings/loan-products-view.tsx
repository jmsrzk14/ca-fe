...
const LOAN_PRODUCTS = [
    {
        no: 1,
        namaProduk: "pINJAMAN",
        kategori: "Modal Kerja",
        tanggalDibuat: "September 30, 2025 - 15:56 WIB",
        tanggalDiubah: "September 30, 2025 - 15:56 WIB"
    },
    {
        no: 2,
        namaProduk: "KREDIT PEGAWAI SWASTA",
        kategori: "Konsumtif",
        tanggalDibuat: "July 9, 2025 - 15:54 WIB",
        tanggalDiubah: "July 9, 2025 - 16:16 WIB"
    },
    {
        no: 3,
        namaProduk: "UMKM",
        kategori: "Modal Kerja",
        tanggalDibuat: "June 30, 2025 - 12:48 WIB",
        tanggalDiubah: "July 25, 2025 - 16:50 WIB"
    }
];
        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-sm font-bold text-foreground">Produk Peminjaman</h2>
                </div>
                ...
                <CardContent className="p-0">
                        ...
                        <Table>
                            <TableHeader className="bg-muted/10">
                                <TableRow className="hover:bg-transparent border-border/50">
                                    ...
                                    <TableHead className="py-4 px-4 font-bold text-[10px] text-muted-foreground uppercase tracking-widest text-left">Nama Produk</TableHead>
                                    ...
                                    <TableHead className="py-4 px-4 font-bold text-[10px] text-muted-foreground uppercase tracking-widest text-left">Tanggal Dibuat</TableHead>
                                    <TableHead className="py-4 px-4 font-bold text-[10px] text-muted-foreground uppercase tracking-widest text-left">Tanggal Diubah</TableHead>
                            ...
                            <TableBody>
                                {LOAN_PRODUCTS.map((row, i) => (
                                    <TableRow key={i} className="border-b border-border/40 hover:bg-primary/5 transition-colors group">
                                        ...
                                        <TableCell className="py-5 px-4 text-xs font-bold text-foreground uppercase">{row.namaProduk}</TableCell>
                                        <TableCell className="py-5 px-4 text-xs font-medium text-foreground/80">{row.kategori}</TableCell>
                                        <TableCell className="py-5 px-4 text-xs text-foreground/70">{row.tanggalDibuat}</TableCell>
                                        <TableCell className="py-5 px-4 text-xs text-foreground/70">{row.tanggalDiubah}</TableCell>
                    ...
                    <div className="px-8 py-6 border-t border-border/40 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <span className="text-xs text-muted-foreground font-medium">
                            Showing 1 to {LOAN_PRODUCTS.length} of {LOAN_PRODUCTS.length} entries
                        </span>
