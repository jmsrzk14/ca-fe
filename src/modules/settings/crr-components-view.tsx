        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-sm font-bold text-foreground">Setup Komponen Credit Risk Rating</h2>
                </div>
                ...
                <CardContent className="p-0">
                        ...
                        <Table>
                            <TableHeader className="bg-muted/10">
                                <TableRow className="hover:bg-transparent border-border/50">
                                    ...
                                    <TableHead className="py-4 px-4 font-bold text-[10px] text-muted-foreground uppercase tracking-widest text-left">Bagian Penilaian</TableHead>
                            ...
                            <TableBody>
                                {CRR_COMPONENTS.map((row, i) => (
                                    <TableRow key={i} className="border-b border-border/40 hover:bg-primary/5 transition-colors group">
                                        ...
                                        <TableCell className="py-5 px-4 text-xs font-medium text-foreground">{row.bagianPenilaian}</TableCell>
                    ...
                    <div className="px-8 py-6 border-t border-border/40 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <span className="text-xs text-muted-foreground font-medium">
                            Showing 1 to {CRR_COMPONENTS.length} of {CRR_COMPONENTS.length} entries
                        </span>
