...
export const referenceService = {
    ...
    createAttributeCategory: (data: any) => client.createAttributeCategory(data),
    updateAttributeCategory: (data: any) => client.updateAttributeCategory(data),
    deleteAttributeCategory: (categoryCode: string) => client.deleteAttributeCategory({ categoryCode }),
